...
instr_func opcode_entry[256] = {
    ...
    /* 0x8c - 0x8f*/ inv, lea_v, mov_rm2sr_w, inv,
    ...
    /* 0xc0 - 0xc3*/ group_2_b, group_2_v, ret_near_iw, ret_near_l,
    ...
    /* 0xe8 - 0xeb*/ call_near_v, jmp_near,jmp_far, jmp_short,
...
instr_func group_5_indirect_entry[8] =
    {inc_v, dec_v, call_gate_v, inv, jmp_near_rm, inv, push_rm_v, inv};
...
instr_func opcode_2_byte_entry[256] = {
    ...
    /* 0x88 - 0x8b*/ js_near, jns_near, jp_near, inv,
